...
ToggleButton.Image = "rbxassetid://7072719338" -- Correct minimize icon asset ID
ToggleButton.ImageRectOffset = Vector2.new(924, 724) -- "minus" icon
...
function animateMain(open)
    local goal = {}
    if open then
        goal.Size = UDim2.new(0, 525, 0, 318)
        goal.Position = UDim2.new(0.5, -262, 0.5, -159)
    ...
    local tween = game:GetService("TweenService"):Create(Main, TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), goal)
    tween:Play()
    return tween
end
...
ToggleButton.MouseButton1Click:Connect(function()
    ...
    close.ZIndex = 2
    close.Image = "rbxassetid://7072725342" -- Correct close icon asset ID
    close.ImageRectOffset = Vector2.new(284, 4) -- "close" icon
    close.ImageRectSize = Vector2.new(24, 24)
    close.MouseButton1Click:Connect(function()
        -- Close all GUIs (destroy all Kavo GUIs and the minimize toggle) with animation
        local t = animateMain(false)
        t.Completed:Wait()
    ...
    minimize.Position = UDim2.new(0.905, 0, 0.137, 0)
    minimize.Size = UDim2.new(0, 21, 0, 21)
    minimize.ZIndex = 2
    minimize.Image = "rbxassetid://7072719338" -- Correct minimize icon asset ID
    minimize.ImageRectOffset = Vector2.new(924, 724) -- "minus" icon
    ...
    function Tabs:NewTab(tabName)
        ...
        tabButton.MouseButton1Click:Connect(function()
            playClickSound() -- Play sound on tab select
            UpdateSize()
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                UpdateSize()
                    ...
                    btn.MouseButton1Click:Connect(function()
                        playClickSound() -- Play sound on toggle press
                        if not focusing then
